...
import { addOrUpdatePost, getFilter, getPostById } from '../../../Services/BlogReponsitory';
...
const Edit = () => {
    ...
    if (id && !isInteger(id))
        return (
            <Navigate to={`/400?redirectTo=/admin/potss`} />
        )
    return (
        <>
        <Form method='post'
            ...
            <div className='row mb-3'>
                <Form.Label className='col-sm-2 col-from-label'>
                    Hình hiện tại
                </Form.Label>
                <div className='col-sm-10'>
